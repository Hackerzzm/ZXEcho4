...
public class ChatActivity extends BaseActivity implements AGEventHandler {
  ...
  @Override protected void initUIandEvent() {
    ...
    String channelName = i.getExtras().getString("channelName");//ConstantApp.ACTION_KEY_CHANNEL_NAME
    String channelKey = i.getExtras().getString("key");
    int zxUid = i.getExtras().getInt("my_uid");
    ...
    worker().joinChannel(channelKey, channelName, zxUid);//config().mUid
