...
public class WorkerThread extends Thread {
  ...
  public WorkerThread(Context context) {
    ...
    com.orhanobut.logger.Logger.d("mEngineConfig.mUid = " + this.mEngineConfig.mUid);
  ...
  private RtcEngine ensureRtcEngineReadyLock() {
    if (mRtcEngine == null) {
      ...
      if (mRtcEngine == null) {
        Log.e("zzm debug!!!", "mRtcEngine is null!!!");
      }
    ...
    @Override public void handleMessage(Message msg) {
      ...
      switch (msg.what) {
        ...
        case ACTION_WORKER_JOIN_CHANNEL:
          ...
          mWorkerThread.joinChannel(null, data[0], msg.arg1);
          break;
