...
import zzm.zxecho.openvcall.ui.ChatActivity;
...
public class ActivityLogin extends Activity {
  ...
  void doJoin() {
    ...
    runOnUiThread(new Runnable() {
      @Override public void run() {
        ...
        CheckBox x = findViewById(R.id.checkBoxVideo);
        if (enableMedia) {
          if (x.isChecked()) {
        ...
        if (enableMediaCertificate) {
          ...
          //log("media key : " + key);
          // TODO: 2017/12/15
          Intent i = new Intent(ActivityLogin.this, ChatActivity.class);
          Bundle b = new Bundle();
  ...
  void doLeave() {
    runOnUiThread(new Runnable() {
      @Override public void run() {
        ...
        video_peer_uid = 0;
        if (remoteView != null) {
          FrameLayout remoteViewContainer = findViewById(R.id.video2);
  ...
  @Override public void onCreate(Bundle savedInstanceState) {
    ...
    {
      final Button btn = findViewById(R.id.buttonEnv);
    ...
    {
      Button btn = findViewById(R.id.buttonInstMsg);
    ...
    {
      final Button btn = findViewById(R.id.buttonCallPhone);
    ...
    {
      final Button btn = findViewById(R.id.buttonCall);
    ...
    {
      CheckBox x = findViewById(R.id.checkBoxSpeaker);
    ...
    {
      CheckBox x = findViewById(R.id.checkBoxMute);
      x.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
        @Override public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
  ...
  public void log(final String s) {
    super.runOnUiThread(new Runnable() {
      @Override public void run() {
        EditText x = findViewById(R.id.editTextLog);
        x.getText().append(s + "\n");
