...
public class ActivityLogin extends Activity {
  ...
  public static String appID = "88c6cea1c8aa408b892d9d632a4d206c";
  public static String certificate = "73f5d0b232b94cf58fd9391cc019f1ff";
  int msgid = 0;
  ...
  @Override public void onCreate(Bundle savedInstanceState) {
      ...
      btn.setOnClickListener(new View.OnClickListener() {
        @Override public void onClick(View arg0) {
          ...
          if (m_iscalling) {
            ...
            m_agoraAPI.channelInvitePhone3(channelName, peer, src,
                "{\"sip_header:myheader\":\"gogo\"}");//(int)Long.parseLong(peerUid))
          }
        }
      });
    }
    ...
    for (int i = 0; i < 1; i++) {
        ...
        try {
          m_agoraMedia = RtcEngine.create(this, appID, new IRtcEngineEventHandler() {
            @Override public void onFirstRemoteVideoDecoded(final int uid, int width, int height,
              ...
              int successCode = m_agoraMedia.setupRemoteVideo(
                  new VideoCanvas(remoteView, VideoCanvas.RENDER_MODE_ADAPTIVE, uid));
              if (successCode < 0) {
                new android.os.Handler().postDelayed(new Runnable() {
                  @Override public void run() {
                    m_agoraMedia.setupRemoteVideo(
                        new VideoCanvas(remoteView, VideoCanvas.RENDER_MODE_ADAPTIVE, uid));
      ...
      m_agoraAPI.callbackSet(new AgoraAPI.CallBack() {
        ...
        @Override public void onInviteMsg(String channelID, String account, int uid, String msgType,
            String msgData, String extra) {
        ...
        @Override public void onInviteAcceptedByPeer(String channleID, String account, int uid,
            String extra) {
