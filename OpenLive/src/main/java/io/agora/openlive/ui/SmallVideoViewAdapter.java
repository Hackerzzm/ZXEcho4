...
public class SmallVideoViewAdapter extends VideoViewAdapter {
  ...
  public SmallVideoViewAdapter(Context context, int exceptedUid, HashMap<Integer, SurfaceView> uids,
  ...
  @Override public void notifyUiChanged(HashMap<Integer, SurfaceView> uids, int uidExcluded,
