...
public class VideoProfileAdapter extends RecyclerView.Adapter {
  ...
  @Override public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    View v = LayoutInflater.from(parent.getContext())
        .inflate(R.layout.video_profile_item, parent, false);
  ...
  @Override public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
    String resolution =
        context.getResources().getStringArray(R.array.string_array_resolutions)[position];
    ((ProfileHolder) holder).resolution.setText(resolution);

    String frameRate =
        context.getResources().getStringArray(R.array.string_array_frame_rate)[position];
    ...
    holder.itemView.setBackgroundResource(
        position == selected ? R.color.lightColorAccent : android.R.color.transparent);
  }
