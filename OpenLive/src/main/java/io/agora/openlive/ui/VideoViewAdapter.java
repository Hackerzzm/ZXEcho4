...
public abstract class VideoViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  public VideoViewAdapter(Context context, int exceptedUid, HashMap<Integer, SurfaceView> uids,
  ...
  public abstract void notifyUiChanged(HashMap<Integer, SurfaceView> uids, int uidExcluded,
