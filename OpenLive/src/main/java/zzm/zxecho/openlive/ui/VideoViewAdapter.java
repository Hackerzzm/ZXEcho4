...
public abstract class VideoViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  public abstract void notifyUiChanged(HashMap<Integer, SurfaceView> uids, int uidExcluded, HashMap<Integer, Integer> status,
      HashMap<Integer, Integer> volume);

  @Override public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    Log.d("VideoViewAdapter", "onCreateViewHolder " + viewType);

    View v = mInflater.inflate(zzm.zxecho.openlive.R.layout.video_view_container, parent, false);
