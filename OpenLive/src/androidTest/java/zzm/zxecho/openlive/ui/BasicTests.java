...
public class BasicTests extends ActivityInstrumentationTestCase2<MainActivity> {
  ...
  public void testJoinAsBroadcaster() throws Exception {
    ...
    solo.clickOnView(solo.getView(zzm.zxecho.openlive.R.id.button_join));

    solo.waitForDialogToOpen(1000);

    solo.clickOnButton(getString(zzm.zxecho.openlive.R.string.label_broadcaster));
  ...
  public void testJoinAsAudience() throws Exception {
    ...
    solo.clickOnButton(getString(zzm.zxecho.openlive.R.string.label_audience));
