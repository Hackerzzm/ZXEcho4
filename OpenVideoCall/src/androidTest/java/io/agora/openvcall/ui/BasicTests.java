...
public class BasicTests extends ActivityInstrumentationTestCase2<MainActivity> {
  ...
  public void testJoinChannel() throws Exception {
    String AUTO_TEST_CHANNEL_NAME =
        "for_auto_test_" + BuildConfig.VERSION_NAME + BuildConfig.VERSION_CODE;
    ...
    solo.waitForLogMessage("onJoinChannelSuccess " + AUTO_TEST_CHANNEL_NAME,
        JOIN_CHANNEL_SUCCESS_THRESHOLD + 1000);
    ...
    solo.waitForLogMessage("onFirstRemoteVideoDecoded ",
        FIRST_REMOTE_VIDEO_RECEIVED_THRESHOLD + 500);

    assertTrue("first remote video frame not received",
        System.currentTimeMillis() - firstRemoteVideoTs <= FIRST_REMOTE_VIDEO_RECEIVED_THRESHOLD);
