...
import zzm.zxecho.openvcall.model.AGEventHandler;
import zzm.zxecho.openvcall.model.ConstantApp;
import zzm.zxecho.openvcall.model.Message;
import zzm.zxecho.openvcall.model.User;
import zzm.zxecho.propeller.Constant;
import zzm.zxecho.propeller.UserStatusData;
import zzm.zxecho.propeller.VideoInfoData;
import zzm.zxecho.propeller.preprocessing.VideoPreProcessing;
import zzm.zxecho.propeller.ui.RtlLinearLayoutManager;
...
public class ChatActivity extends BaseActivity implements AGEventHandler {
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(zzm.zxecho.openvcall.R.layout.activity_chat);
  }
  ...
  @Override protected void initUIandEvent() {
    ...
    mGridVideoViewContainer = (GridVideoViewContainer) findViewById(zzm.zxecho.openvcall.R.id.grid_video_view_container);
    ...
    TextView textChannelName = (TextView) findViewById(zzm.zxecho.openvcall.R.id.channel_name);
    textChannelName.setText(channelName);

    optional();

    LinearLayout bottomContainer = (LinearLayout) findViewById(zzm.zxecho.openvcall.R.id.bottom_container);
  ...
  public void onClickHideIME(View view) {
    ...
    closeIME(findViewById(zzm.zxecho.openvcall.R.id.msg_content));

    findViewById(zzm.zxecho.openvcall.R.id.msg_input_container).setVisibility(View.GONE);
    findViewById(zzm.zxecho.openvcall.R.id.bottom_action_end_call).setVisibility(View.VISIBLE);
    findViewById(zzm.zxecho.openvcall.R.id.bottom_action_container).setVisibility(View.VISIBLE);
  }

  private void initMessageList() {
    mMsgList = new ArrayList<>();
    RecyclerView msgListView = (RecyclerView) findViewById(zzm.zxecho.openvcall.R.id.msg_list);
  ...
  private void showMessageEditContainer() {
    findViewById(zzm.zxecho.openvcall.R.id.bottom_action_container).setVisibility(View.GONE);
    findViewById(zzm.zxecho.openvcall.R.id.bottom_action_end_call).setVisibility(View.GONE);
    findViewById(zzm.zxecho.openvcall.R.id.msg_input_container).setVisibility(View.VISIBLE);

    EditText edit = (EditText) findViewById(zzm.zxecho.openvcall.R.id.msg_content);
  ...
  public void onBtnNClicked(View view) {
    ...
    if (showing != null && (Boolean) showing) {
      ...
      iv.setTag(true);
      iv.setColorFilter(getResources().getColor(zzm.zxecho.openvcall.R.color.agora_blue), PorterDuff.Mode.MULTIPLY);
    }
  }
  ...
  public void onVoiceChatClicked(View view) {
    ...
    iv.setImageResource(mVideoMuted ? zzm.zxecho.openvcall.R.drawable.btn_video : zzm.zxecho.openvcall.R.drawable.btn_voice);
  ...
  private void resetToVideoEnabledUI() {
    ImageView iv = (ImageView) findViewById(zzm.zxecho.openvcall.R.id.customized_function_id);
    iv.setImageResource(zzm.zxecho.openvcall.R.drawable.btn_switch_camera);
    iv.clearColorFilter();
  ...
  private void resetToVideoDisabledUI() {
    ImageView iv = (ImageView) findViewById(zzm.zxecho.openvcall.R.id.customized_function_id);
    iv.setImageResource(zzm.zxecho.openvcall.R.drawable.btn_speaker);
    iv.clearColorFilter();
    ...
    switch (type) {
      ...
      case AGEventHandler.EVENT_TYPE_ON_USER_VIDEO_STATS:
        ...
        if (Constant.SHOW_VIDEO_INFO) {
          if (mLayoutType == LAYOUT_TYPE_DEFAULT) {
            ...
            String resolution = getResources().getStringArray(zzm.zxecho.openvcall.R.array.string_array_resolutions)[profileIndex];
            String fps = getResources().getStringArray(zzm.zxecho.openvcall.R.array.string_array_frame_rate)[profileIndex];
            String bitrate = getResources().getStringArray(zzm.zxecho.openvcall.R.array.string_array_bit_rate)[profileIndex];
      ...
      case AGEventHandler.EVENT_TYPE_ON_APP_ERROR:
        ...
        if (subType == ConstantApp.AppError.NO_NETWORK_CONNECTION) {
          showLongToast(getString(zzm.zxecho.openvcall.R.string.msg_no_network_connection));
        }
  ...
  private void bindToSmallVideoView(int exceptUid) {
    if (mSmallVideoViewDock == null) {
      ViewStub stub = (ViewStub) findViewById(zzm.zxecho.openvcall.R.id.small_video_view_dock);
      mSmallVideoViewDock = (RelativeLayout) stub.inflate();
    }

    boolean twoWayVideoCall = mUidsList.size() == 2;

    RecyclerView recycler = (RecyclerView) findViewById(zzm.zxecho.openvcall.R.id.small_video_view_container);
