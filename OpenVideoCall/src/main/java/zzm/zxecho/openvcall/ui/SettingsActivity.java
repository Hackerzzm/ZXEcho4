...
public class SettingsActivity extends AppCompatActivity {
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(zzm.zxecho.openvcall.R.layout.activity_settings);

    initUi();
  }

  private void initUi() {
    RecyclerView v_profiles = (RecyclerView) findViewById(zzm.zxecho.openvcall.R.id.profiles);
  ...
  @Override public boolean onCreateOptionsMenu(Menu menu) {
    ...
    inflater.inflate(zzm.zxecho.openvcall.R.menu.menu_settings, menu);
    return true;
  }
  ...
  @Override public boolean onOptionsItemSelected(MenuItem item) {
    ...
    switch (item.getItemId()) {
      case zzm.zxecho.openvcall.R.id.confirm:
        doSaveProfile();
