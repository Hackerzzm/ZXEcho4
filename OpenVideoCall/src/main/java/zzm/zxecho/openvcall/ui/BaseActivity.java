...
import zzm.zxecho.openvcall.AGApplication;
import zzm.zxecho.openvcall.BuildConfig;
import zzm.zxecho.openvcall.model.ConstantApp;
import zzm.zxecho.openvcall.model.CurrentUserSettings;
import zzm.zxecho.openvcall.model.EngineConfig;
import zzm.zxecho.openvcall.model.MyEngineEventHandler;
...
public abstract class BaseActivity extends AppCompatActivity {
  ...
  protected void initVersionInfo() {
    String version = "V "
        ...
        + ", "
        + ConstantApp.APP_BUILD_DATE
        + ", SDK: "
        + Constant.MEDIA_SDK_VERSION
        + ")";
