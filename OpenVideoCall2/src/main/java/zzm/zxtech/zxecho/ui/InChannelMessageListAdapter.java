...
public class InChannelMessageListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  @Override public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    View v = mInflater.inflate(zzm.zxtech.zxecho.R.layout.in_channel_message, parent, false);
  ...
  @Override public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
    ...
    if (TextUtils.isEmpty(sender)) {
      myHolder.itemView.setBackgroundResource(zzm.zxtech.zxecho.R.drawable.rounded_bg_blue);
    } else {
      myHolder.itemView.setBackgroundResource(zzm.zxtech.zxecho.R.drawable.rounded_bg);
    }
  ...
  public class MessageHolder extends RecyclerView.ViewHolder {
    ...
    public MessageHolder(View v) {
      super(v);
      msgContent = (TextView) v.findViewById(zzm.zxtech.zxecho.R.id.msg_content);
    }
  }
}
