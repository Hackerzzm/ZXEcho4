...
public class SettingsActivity extends AppCompatActivity {
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(zzm.zxtech.zxecho.R.layout.activity_settings);

    initUi();
  }

  private void initUi() {
    RecyclerView v_profiles = (RecyclerView) findViewById(zzm.zxtech.zxecho.R.id.profiles);
  ...
  @Override public boolean onCreateOptionsMenu(Menu menu) {
    ...
    inflater.inflate(zzm.zxtech.zxecho.R.menu.menu_settings, menu);
    return true;
  }
  ...
  @Override public boolean onOptionsItemSelected(MenuItem item) {
    ...
    switch (item.getItemId()) {
      case zzm.zxtech.zxecho.R.id.confirm:
        doSaveProfile();
